...
public class ClienteController {
    ...
    * */
    ...
    public String guardar(@Valid Cliente cliente, BindingResult bindingResult, Model model, RedirectAttributes flash, SessionStatus status){  //No olvidar marcar con valid
